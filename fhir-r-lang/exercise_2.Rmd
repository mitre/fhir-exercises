...
table_desc_patient <- fhir_table_description(
        ...
        cols = c(
                id            = "id",
                gender        = "gender",
                race_string = "extension[@url=\"http://hl7.org/fhir/us/core/StructureDefinition/us-core-race\"]/extension[@url=\"text\"]/valueString",
                race_coding_display = "extension[@url=\"http://hl7.org/fhir/us/core/StructureDefinition/us-core-race\"]/extension[@url=\"text\"]/valueCoding/display",
                race_coding_code = "extension[@url=\"http://hl7.org/fhir/us/core/StructureDefinition/us-core-race\"]/extension[@url=\"text\"]/valueCoding/code",
                ethnicity_string = "extension[@url=\"http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity\"]/extension[@url=\"text\"]/valueString",
                ethnicity_coding_display = "extension[@url=\"http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity\"]/extension[@url=\"text\"]/valueCoding/display",
                ethnicity_coding_code = "extension[@url=\"http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity\"]/extension[@url=\"text\"]/valueCoding/code"
        )
...
🖐 Fill in the query to request 250 Condition resources from the server
...
df_observation <- df_observation %>% 
  ...
  filter(
    !is.na(effectiveDateTime_duration)
  ) %>% 
  mutate(
    onsetAgeInYears = as.numeric(effectiveDateTime_duration) / 365
  )

df_observation
```

**TODO:** finish translation of this last section pending updates to the Python version.
